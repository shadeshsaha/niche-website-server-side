...
const uri = "mongodb+srv://BikersParadise:iHffvDOGK2B3reWr@cluster0.dv4ff.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
...
async function run() {
  try {
    ...
    const database = client.db("BikersParadise");
